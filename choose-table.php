  ...
  <body style="background-image:url('images/squares.png')">
   ...
   <?php include 'template/nav-bar.php'; ?>
    ...
    <section class="home-slider owl-carousel" style="height: 400px;">
      <div class="slider-item" style="background-image: url('images/nine.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section"  >
      <div class="container" style="background-image: url('images/log4.jpg');">
