  ...
  <body>
   ...
   <?php include 'template/nav-bar.php'; ?>
    ...
    <section class="home-slider owl-carousel"  >
      <div class="slider-item" style="background-image: url('images/ten.jpg');">
     ...
     <div class="ftco-section-reservation"   >
      <div class="container">
        <div class="row">
          ...
          <center><p style="font-size: 20px; color: #000;font-weight: bold;margin-top: -30px">Make a Reservation</p></center>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 ftco-animate img" style="background-image: url(images/log6.jpg);"></div>
